...
T.Switch {
    ...
    indicator: PaddedRectangle {
        ...
        border.color: control.checked ? TritonStyle.accentColor : TritonStyle.primaryTextColor
        ...
        Rectangle {
            ...
            height: width
            radius: width/2
            color: control.checked ? TritonStyle.accentColor : TritonStyle.primaryTextColor
