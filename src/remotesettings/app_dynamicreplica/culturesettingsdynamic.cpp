...
CultureSettingsDynamic::CultureSettingsDynamic()
{

}

QString CultureSettingsDynamic::language() const
{
...
QVariantList CultureSettingsDynamic::languages() const
{
    if (m_replicaPtr.isNull())
        return QVariantList();
...
void CultureSettingsDynamic::initialize()
{
...
void CultureSettingsDynamic::setLanguage(const QString &language)
{
    if (m_replicaPtr.isNull())
        return;
