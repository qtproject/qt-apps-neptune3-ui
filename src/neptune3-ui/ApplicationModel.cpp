...
void ApplicationModel::onWindowReady(int index, QQuickItem *window)
{
    ...
    if (isRegularApp) {
        ...
        if (isSecondaryWindow) {
            ...
            windowManager->setWindowProperty(window, QStringLiteral("neptuneWidgetHeight"), QVariant(appInfo->widgetHeight()));
            windowManager->setWindowProperty(window, QStringLiteral("neptuneCurrentWidth"), QVariant(appInfo->currentWidth()));
            windowManager->setWindowProperty(window, QStringLiteral("neptuneCurrentHeight"), QVariant(appInfo->currentHeight()));
            windowManager->setWindowProperty(window, QStringLiteral("neptuneState"), QVariant(appInfo->windowState()));
